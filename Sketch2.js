...
function setup (){
   database = firebase.database();
    ...
    form  = new Form();
    back1   = new Button('Back',25,525,'back1');  
    back2  = new Button('Back',75,525,'back2');
    back3 = new Button('Back',305,525,'back3');
...
if(gameState === "form"){
    ...
    headtext.html("If you are already an user you will be logged  ");
    headtext.position(100,100);
    headtext.show();
    headtext2.html("in few seconds else kindly make an account");
    headtext2.position(100,140);
    headtext2.style('color','white');
    headtext2.show();
    ...
    firebase.auth().onAuthStateChanged(function(user){
     ...
     displayname.position(250,370);
    displayname.show();
   
    message.position(250,300);
    message.show();
    email.position(250,425);
    email.show();
    password.position(250,500);
    password.show();
    login.position(350,550);
    createAccount.position(350,600);
    fill("brown");
     rect(230,300,200,250);
     login.mousePressed(()=>{
        alert("testing");
